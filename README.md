...
- **Dispositivo**: un Raspberry Pi con un auricular Bluetooth, alojado en una carcasa de diseño propio impresa en 3D, captura la voz del clínico durante la exploración.
...
- **Plataforma web**: el diseño contemplaba enviar los datos recogidos a una web (Vercel + PostgreSQL) donde el equipo clínico pudiera consultar los registros de cada exploración.

Así presentamos esa idea en la demo final del hackathon. Por un lado, el panel donde el equipo clínico consultaría el listado de exploraciones registradas y su estado:

<p align="center">
  <img src="docs/mockup-panel-registros.jpg" alt="Mockup: panel de consulta de registros" width="700">
</p>

Y por otro, la pantalla que veía el clínico mientras dictaba los parámetros del pólipo durante la propia exploración:

<p align="center">
  <img src="docs/mockup-interaccion-voz.jpg" alt="Mockup: interacción por voz durante la exploración" width="700">
</p>
